				...
				<div class="grid_12">
					...
					<div id="question" class="grid_12">
						...
						<form class="ac-custom ac-checkbox ac-checkmark" autocomplete="off">
							<ol>
								<li><input id="a" type="checkbox" value="A"><label for="a"><span><?php echo _("A"); ?></span></label></li>
								<li><input id="b" type="checkbox" value="B"><label for="b"><span><?php echo _("B"); ?></span></label></li>
								<li><input id="c" type="checkbox" value="C"><label for="c"><span><?php echo _("C"); ?></span></label></li>
								<li><input id="d" type="checkbox" value="D"><label for="d"><span><?php echo _("D"); ?></span></label></li>
							<ol>
						</form>
					</div>
