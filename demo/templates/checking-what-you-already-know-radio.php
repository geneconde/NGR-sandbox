					...
					<div id="question">
						...
						<div class="grid_12">
							<form class="ac-custom ac-radio ac-swirl" autocomplete="off">
								<ol>
									<li><input id="a" type="radio"><label for="a"><span><?php echo _("A"); ?></span></label></li>
									<li><input id="b" type="radio"><label for="b"><span><?php echo _("B"); ?></span></label></li>
									<li><input id="c" type="radio"><label for="c"><span><?php echo _("C"); ?></span></label></li>
									<li><input id="d" type="radio"><label for="d"><span><?php echo _("D"); ?></span></label></li>
								<ol>
							</form>
						</div>
					</div>
