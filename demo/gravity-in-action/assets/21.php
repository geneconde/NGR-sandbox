			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question">
						...
						<h2 class="grid_12"><?php echo _("Look at the figure below. Which statement is <span class='blink'>TRUE</span>? (Note: Be careful! The size of the object doesn’t represent the mass of the object!)"); ?></h2>
					...
					<div id="answer">
						...
						<div class="grid_4 prefix_4">
							<div id="fig_desc2">
								<p class="grid_12 prefix_1"><?php echo _('- A "lead" ball having a mass of 100 kilograms'); ?> </p>
								<p class="grid_12 prefix_1"><?php echo _('2 - An "aluminum" ball having a mass of 75 kilograms'); ?> </p>
								<p class="grid_12 prefix_1"><?php echo _('- A "steel" ball having a mass of 50 kilograms.'); ?> </p>
