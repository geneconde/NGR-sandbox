...
@media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : portrait) and (-webkit-min-device-pixel-ratio: 1) {
	#question2 li, #question2 input[type="radio"] + label img,#question2 label {width: 173px;}
	#answer2 .placeholder {width: 525px;}
	#question2 li {margin-right: 5px; float: left; display: inline;}
}
