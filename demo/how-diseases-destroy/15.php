...
.wrap {border-left: 1px dashed #98E279; border-right: 1px dashed #98E279;}
h1 { color: #7c3e1c;font-size:34px;}
h2 { color: black; font-size:24px; padding-left: 2px;}
.bg section{width:95%; margin:0 auto; position:relative; top:20px; min-height:100px;}
...
<body>
	<div class="wrap" >
		<div class="bg">
			<section>
				<h1><?php echo _("Checking what you now know... about how diseases destroy"); ?></h1><br><br>
