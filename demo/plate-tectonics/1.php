...
<head>
	...
	<style>
		h1 { text-align: center; color: #128643; }
		
		.wrap { border-color: #76E8FF; }
		.bg { background-image: url(assets/1/bg.jpg); background-size: 100% 100%; overflow: hidden;}
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="screen1" class="screen">
						<h1 class="grid_12"><?php echo _("Welcome to the Plate Tectonics module"); ?>, <?php echo $user->getFirstName() . "!" ?></h1>
