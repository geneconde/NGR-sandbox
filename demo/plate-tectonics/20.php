...
<head>
	...
	<style>
		...
		.wrap { border-color: #D9F5FF; }
		.bg { background-image: url(assets/20/bg.jpg); background-size: 100% 100% !important; overflow: hidden;}
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Plate Tectonics module."); ?></p>
					</div>
