...
h1 { color: #780853;}
h2 {text-align:left; margin:0; font-weight:normal;}
p { color: black; }
.bg section{width:95%; margin:0 auto; position:relative; top:5px; min-height:100px;}
...
#choices {margin:4px 0 0 0; ;width:100%; }
...
@media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : landscape) {
	#answer  section div { margin-bottom: 0;  }
}	
		...
		<div class="bg" >
			<div id="screen1" class="screens">				
					<section id="col1">					
						...
						<h2><?php echo _("Question A. In order to test a hypothesis, it is sometimes helpful to have a measurable outcome. Which of the following statements has an outcome that can be measured?");?><br/></h2>					
