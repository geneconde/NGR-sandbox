...
figure{width:65%; max-height:95%; margin:0 auto; max-height:95%; margin-top:-20px;}
figure img {width: 90%;}
...
#scrn2_img {width:40%; max-height:95%; margin:0 auto; max-height:95%; margin-top: 5px; position:relative; }
...
@media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : landscape) {
	#screen1 p { padding-top: 0; }
	#screen1 p { font-size: 22px; }
	figure { margin-top: 0; }
	#screen2 p { font-size: 20px; line-height: 25px; }
}	
