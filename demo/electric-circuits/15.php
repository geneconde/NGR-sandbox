...
<head>
	...
	<style>
		...
		.bg { background-image: url(assets/15/15.jpg); overflow: hidden; }
...
<body>
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Checking what you now know about... electric circuits"); ?></h1>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Check what you now know"); ?></strong></section></section>
