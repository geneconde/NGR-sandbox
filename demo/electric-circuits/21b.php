		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
						...
						<div class="container grid_12">
							<div id="container">								
								...
								<ul id="col1" class="grid_12">
									<li><div class="lBox _jsPlumb_endpoint_anchor_" id="c1"><p></p><img src="assets/21/stock-photo-isolated-washing-machine-on-a-white-background-71039011.jpg"></div></li>
									<li><div class="lBox _jsPlumb_endpoint_anchor_" id="c2"><p></p><img src="assets/21/stock-photo-black-digital-alarm-clock-radio-105997673.jpg"></div></li>
									<li><div class="lBox _jsPlumb_endpoint_anchor_" id="c3"><p></p><img src="assets/21/stock-photo-battery-drill-55303534.jpg"></div></li>
									<li><div class="lBox _jsPlumb_endpoint_anchor_" id="c4"><p></p><img src="assets/21/stock-photo-automatic-mixer-isolated-under-the-white-background-156866018.jpg"></div></li>
								</ul>
								<div class="clear"></div>
								<ul id="col2" class="grid_12">
									<li><div class="rBox _jsPlumb_endpoint_anchor_" id="ca"><img src="assets/21/stock-photo-old-winding-key-insert-to-wind-up-the-clock-on-white-background-202473523.jpg"><p></p></div></li>
									<li><div class="rBox _jsPlumb_endpoint_anchor_" id="cb"><img src="assets/21/stock-photo-old-rusty-hand-drill-over-white-100673161.jpg"><p></p></div></li>
									<li><div class="rBox _jsPlumb_endpoint_anchor_" id="cc"><img src="assets/21/stock-photo-vintage-hand-mixer-isolated-on-a-white-background-24340090.jpg"><p></p></div></li>
									<li><div class="rBox _jsPlumb_endpoint_anchor_" id="cd"><img src="assets/21/stock-photo--th-century-washing-machine-583964.jpg"><p></p></div></li>
								</ul>
					...
					<div id="answer">
						<h1 class="grid_12">Quiz Question #2 - How did I do?</h1>

						<p class="grid_12">You answered...</p>
	...
	<script>
		...
		function save() {
			...
			if (answer1 == 'cd' && answer2 == 'ca' && answer3 == 'cb' && answer4 == 'cc' ) {
				$('#answer .feedback').html("<p class='green'><img src='assets/correct.png'>You’ve got it!  A washing machine, a clock, a drill and a mixer.  All these items used to be powered by hand, but are now powered by electricity.!</p>");
			} else {
				$('#answer .feedback').html("<p class='red'><img src='assets/wrong.png'>Not quite!  A modern electric washing machine looks quite different from the hold hand-powered version.  The same goes for the hand drill and mixer.  Although the objects look quite different from their historical counterparts, they allow us to do the same jobs with less effort.</p>");
			}
