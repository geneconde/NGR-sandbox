...
<head>
	...
	<style>
		...
		p { text-align: center; margin: 2% 0; color: #000;/*  padding: 5px 10px; background: rgba(255, 255, 255, .6); color: #000; border-radius: 5px; */ }
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Electric Circuits module."); ?></p>
					</div>
