...
#q1 img { width: 276px; height:200px; 
...
<body>
	<div class="wrap">
		<div class="bg">
			<div id="question">
				...
				<h2><?php echo _("Which of the following is affected by the respiratory system?"); ?></h2>
				<div id="q1">	
					<ul id="choices1">
						<li>
							<input type="radio" id="a1" name="question1" value="A">
							<label for="a1"><img src="images/20/hiccup.png"><span id="A"><?php echo _("Hiccup"); ?></span></label>
						</li>
						<li>
							<input type="radio" id="b1" name="question1" value="B">
							<label for="b1"><img src="images/20/sneeze.png"><span id="B"><?php echo _("Sneeze"); ?></span></label>
						</li>
						 <li>
							<input type="radio" id="c1" name="question1" value="C">
							<label for="c1"><img src="images/20/yawn.png"><span id="C"><?php echo _("Yawn"); ?></span></label>
						</li>
						<li>
							<input type="radio" id="d1" name="question1" value="D">
							<label for="d1"><img src="images/20/all.png"><span id="D"><?php echo _("All of the above"); ?></span></label>
						</li> 
					</ul>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Inhale... exhale..."); ?></strong></section></section>
	<script>
	var feedback = "";	
	var studentAnswer1 = "";
	...
	$(document).ready(function() {
		...
		switch(studentAnswer1){
				case 'A':
				feedback="<?php echo _("Not quite! Hiccups are the sudden movements of the diaphragm, but it's not the only one affected by the respiratory system."); ?>";
				$('#selected_img').attr("src","images/20/hiccup.png");
				$('#feedback').addClass('red');
				$('#answer-icon').attr("src", "images/others/wrong.png");
				$('#chosen-answer').text('<?php echo _("Hiccup"); ?>');
			break;
			
			case 'B':
				feedback="<?php echo _("Not quite! Sneezing is like a cough in the upper breathing passages, but it's not the only one affected by the respiratory system."); ?>";
				$('#selected_img').attr("src","images/20/sneeze.png");
				$('#feedback').addClass('red');
				$('#answer-icon').attr("src", "images/others/wrong.png");
				$('#chosen-answer').text('<?php echo _("Sneeze"); ?>');	
			break;
			
			case 'C':
			feedback="<?php echo _("Not quite! Yawning happens when your lungs do not take enough oxygen from the air because we are sleepy or drowsy. But it's not the only one affected by the respiratory system."); ?>";
			$('#selected_img').attr("src","images/20/yawn.png");
			$('#feedback').addClass('red');
			$('#answer-icon').attr("src", "images/others/wrong.png");
			$('#chosen-answer').text('<?php echo _("Yawn"); ?>');
			break;
			
			case 'D':
			feedback="<?php echo _('Correct! Hiccupping, sneezing, and yawning are all affected by the respiratory system.'); ?>";
			$('#feedback').addClass('green');
			$('#selected_img').attr("src","images/20/all.png");
			$('#answer-icon').attr("src", "images/others/correct.png");	
			$('#chosen-answer').text('<?php echo _("All of the above"); ?>');	
			break;
			default:break;
		}
	...
	function save(){
		//saveAnswer('staying-healthy-qq3', studentAnswer1);
		//answered = 1;		
	}
