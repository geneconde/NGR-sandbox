<?php
	...
	if ($_SESSION["lang"] == "ar_EG") $currentLang = "Arabic";
	if ($_SESSION["lang"] == "es_ES") $currentLang = "Spanish";
	if ($_SESSION["lang"] == "zh_CN") $currentLang = "Chinese";
...
<ul class="lang-menu">
	...
	<li>
		...
		<a href="#">Language: <?php echo $currentLang; ?></a>
		<ul>
