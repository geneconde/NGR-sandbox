...
<style>
h1 { color: #A75E25; }
#canvas { position: absolute; z-index: 2; margin: 0 auto; background: #fff; }
...
<body onload="init();">
	<div class="wrap">
		...
		<div class="bg">
			<div>
				<h1><?php echo _("Thinking about... staying healthy"); ?></h1>
				<p><?php echo _("People come in all ages, shapes and sizes; but we do have one important thing in common. We'll feel better and live longer and more comfortably if we understand and take care of our bodies. The human body is more complex than any machine ever designed, and yet it is very reliable, lasts a long time, and can usually fix itself when something goes wrong."); ?></p>
			</div>
		</div>
	</div>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Are you ready,"); ?> <?php echo( ucfirst($name)."?"); ?></strong></section></section> <!-- Change to student name soon -->
