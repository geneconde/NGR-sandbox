...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question" class="grid_12">
						...
						<h2><?php echo _("What is the major function of ribosomes?"); ?></h2>

						<form class="ac-custom ac-radio ac-swirl" autocomplete="off">
							<ol>
								<li><input id="a" name="q" type="radio" value="A"><label for="a"><span><?php echo _("Store information."); ?></span></label></li>
								<li><input id="b" name="q" type="radio" value="B"><label for="b"><span><?php echo _("Release energy."); ?></span></label></li>
								<li><input id="c" name="q" type="radio" value="C"><label for="c"><span><?php echo _("Capture energy from the sun."); ?></span></label></li>
								<li><input id="d" name="q" type="radio" value="D"><label for="d"><span><?php echo _("Make proteins."); ?></span></label></li>
							<ol>
						</form>
					</div>
	...
	<div id="buttons">
		...
		<a href="24.php" class="next" title="<?php echo _("Next"); ?>"><?php echo _("Next"); ?></a>
	...
	<script>
		...
		function save() {
			...
			if (answer == 'A')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No. Information is stored in the nucleus."); ?></p>");

			if (answer == 'B')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Sorry. Mitochondria release energy."); ?></p>");

			if (answer == 'C')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope. Chloroplasts capture solar energy."); ?></p>");

			if (answer == 'D')
				$('.feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("Yes! Ribosomes are responsible for making protein."); ?></p>");
