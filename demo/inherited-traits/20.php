...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question" class="grid_12">
						...
						<h2 class="grid_12"><?php echo _("What are the genotypes of the parents in this mating?"); ?></h2>
						...
						<div class="grid_12">
							<form class="ac-custom ac-radio ac-swirl" autocomplete="off">
								<ol>
									<li><input id="a" name="q1" type="radio" value="A"><label for="a"><span><?php echo _("BB x BB"); ?></span></label></li>
									
									<li><input id="b" name="q1" type="radio" value="B"><label for="b"><span><?php echo _("bb x bb"); ?></span></label></li>
									
									<li><input id="c" name="q1" type="radio" value="C"><label for="c"><span><?php echo _("bb x Bb"); ?></span></label></li>
									
									<li><input id="d" name="q1" type="radio" value="D"><label for="d"><span><?php echo _("Bb x Bb"); ?></span></label></li>
								<ol>
							</form>
						</div>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Brown or White?"); ?></strong></section></section>
	...
	<script>
		...
		function save() {
			...
			if (answer == 'A') {
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No. These parents can have only brown offspring."); ?></p>");
			
			} else if (answer == 'B'){
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Sorry. These parents can have only white offspring."); ?></p>");

			} else if(answer == 'C'){
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Not likely. These parents should have about equal numbers of brown and white offspring."); ?></p>");

			} else {
			
				$('.feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("That's it. These parents expect to have ¾ brown and ¼ white offspring."); ?></p>");
			}

			console.log(answer);

			if (answered == 0) {
				saveAnswer('inherited-traits-qq5-a', answer); // Correct answer: D
				answered = 1;
			}
		}
