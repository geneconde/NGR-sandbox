...
<head>
	...
	<style>
		...
		#results { display: block; background-color: #634F4E; margin-top: 10%; color: #fff; padding: 9px 24px; text-align: center; border-radius: 5px; border: 2px solid #7CC576;} 
		#results:hover { background: #FEF1BC; color: #634F4E; } 
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Inherited Traits module."); ?></p>
					</div>
