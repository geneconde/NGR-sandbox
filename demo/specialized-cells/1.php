...
<head>
	...
	<style>
		h1 { color: #ec9c66; padding-top: 50px; text-align: center;}
		
		.wrap { border-color: #0f3693; max-height: 100%;}
		.bg { background-color: #fff;background-image: url(assets/1/bg.jpg); }
		...
		@media screen and (max-width: 1250px ){
			.bg{ 	background-size: 100% calc(100% - 0px)!important;
					overflow: hidden;
			}
		}
		</style>
		...
		<div class="bg">
			<div class="container_12">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Welcome to the Specialized Cells module") . ', ' . $user->getFirstName() . '!'; ?></h1>
