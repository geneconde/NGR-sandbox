...
<head>
	...
	<style>
		...
		.wrap { border-color: #FFBBFE; }
		.bg { background-image: url(assets/24/bg.jpg); background-size: 100% 100% !important; }

		#results { display: block; background-color: #d62b00; margin-top: 10%; color: #fff; padding: 9px 24px; text-align: center; border-radius: 5px; } 
		#results:hover { background: #D61100; } 
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Specialized Cells module."); ?></p>
					</div>
