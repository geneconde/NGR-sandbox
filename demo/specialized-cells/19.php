			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question">
						...
						<h2 class="grid_12"><?php echo _('What is a major function of dendrites?'); ?></h2>

						<ul class="grid_7">						
							<li>A. <?php echo _("Provide connections to other nerve cells."); ?></li>
							<li>B. <?php echo _("Their contracting motion helps to propel blood."); ?></li>
							<li>C. <?php echo _("Make connections between bone and muscle."); ?></li>
							<li>D. <?php echo _("Provide protection against bacterial threats."); ?></li>
						</ul>
	...
	<script>
		...
		function save() {
			...
			if (hexaValue == './assets/A.png') {
				$('.answer').html('<img src="assets/A.png"><span><?php echo _("Provide connections to other nerve cells."); ?></span>');
				$('.feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("Correct! The many dendrites of nerve cells allow them to form networks with other nerve cells."); ?></p>");

				answer = 'A';
			}

			if (hexaValue == './assets/B.png') {
				$('.answer').html("<img src='assets/B.png'><span><?php echo _("Their contracting motion helps to propel blood."); ?></span>");
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Sorry. Muscle cells are able to contract."); ?></p>");

				answer = 'B';
			}

			if (hexaValue == './assets/C.png') {
				$('.answer').html("<img src='assets/C.png'><span><?php echo _("Make connections between bone and muscle."); ?></span>");
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No. Tendons connect muscles to bones."); ?></p>");

				answer = 'C';
			}

			if (hexaValue == './assets/D.png') {
				$('.answer').html("<img src='assets/D.png'><span><?php echo _("Provide protection against bacterial threats."); ?></span>");
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Oops. White blood cells make up the immune system."); ?></p>");
