...
<head>
	...
	<style>
		...
		#question > div:nth-last-child(-n+2) { margin-top: 20px; }
	</style>
</head>
...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question">
						...
						<h2 class="grid_12"><?php echo _("Any time anything is happening in the universe, or any changes occur to anything in the universe, those events require:"); ?></h2>

						<div class="grid_4 prefix_1 suffix_2">
							<input type="radio" id="a" name="q" value="A">
							<label for="a"><img src="assets/19/a.jpg"><span><?php echo _("Energy"); ?></span></label>
						</div>

						<div class="grid_4">
							<input type="radio" id="b" name="q" value="B">
							<label for="b"><img src="assets/19/b.jpg"><span><?php echo _("Force"); ?></span></label>
						</div>

						<div class="grid_4 prefix_1 suffix_2">
							<input type="radio" id="c" name="q" value="C">
							<label for="c"><img src="assets/19/c.jpg"><span><?php echo _("Human"); ?></span></label>
						</div>

						<div class="grid_4">
							<input type="radio" id="d" name="q" value="D">
							<label for="d"><img src="assets/19/d.jpg"><span><?php echo _("The Sun"); ?></span></label>
						</div>
	...
	<script>
		...
		function save() {
			...
			if (answer == 'A')
				$('.feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("Yes - Energy is required for all changes to occur in the universe."); ?></p>");

			if (answer == 'B')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Not quite - Force is a push or a pull. Some changes that happen, like thinking, require energy but not a force."); ?></p>");

			if (answer == 'C')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Not really - lots of things happen in the universe that humans aren't involved in."); ?></p>");

			if (answer == 'D')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Not quite - the Sun provides energy for many changes that happen in our solar system but not everything. And outside our solar system, in the big universe, our sun doesn't provide any energy impact at all."); ?></p>");
