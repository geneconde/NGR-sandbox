	...
	<script>
		...
		$('#question2').find('input[type=radio]').on('click', function() {
			...
			if (id == 'a') {
				...
				$('#answer2').find('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – When water evaporates, it seems to disappear because you can't see it anymore, but it still exists and is mixed in with the atmosphere."); ?></p>");
			...
			if (id == 'b') {
				$('#answer2').find('.answer').html(text);
				$('#answer2').find('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – It does change into a gas – water vapor – but it still has the same mass and weight as it did before."); ?></p>");
			...
			if (id == 'c') {
				$('#answer2').find('.answer').html(text);
				$('#answer2').find('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – It does change into a gas – water vapor – but it doesn't lose any weight - it still has the same mass and weight as it did before."); ?></p>");
		...
		function save() {
			...
			if (hexaValue == './assets/a.png') {
				...
				$('#answer1').find('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Solid  is a state of matter."); ?></p>");
			...
			if (hexaValue == './assets/c.png') {
				...
				$('#answer1').find('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Liquid  is a state of matter."); ?></p>");
			...
			if (hexaValue == './assets/d.png') {
				...
				$('#answer1').find('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Gas  is a state of matter."); ?></p>");
