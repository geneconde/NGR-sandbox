...
<body>
	...
	<script>
		...
		function save() {
			...
			if (answer1 == 'A')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Salt is a compound NaCl of the two elements Sodium (Na) and Chlorine (Cl)."); ?></p>");

			if (answer1 == 'B')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Sugar is a compound molecule C<sub>6</sub>H<sub>12</sub>O<sub>6</sub> consisting of several atoms of the elements Carbon, Hydrogen, and Oxygen."); ?></p>");

			if (answer1 == 'C')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Water is a compound H2O of the elements Hydrogen and Oxygen."); ?></p>");

			if (answer1 == 'D')
				$('#answer1 .feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("Correct – Oxygen is an element."); ?></p>");

			if (answer2 == 'A')
				$('#answer2 .feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("Correct – Sugar is a compound molecule consisting of several atoms of the elements Carbon, Hydrogen, and Oxygen."); ?></p>");

			if (answer2 == 'B')
				$('#answer2 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Iron is an element."); ?></p>");

			if (answer2 == 'C')
				$('#answer2 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Hydrogen is an element."); ?></p>");

			if (answer2 == 'D')
				$('#answer2 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Oxygen is an element."); ?></p>");
