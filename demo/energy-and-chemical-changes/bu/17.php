...
<body>
	...
	<div id="buttons">
		...
		<a href="18.php" class="next" title="<?php echo _("Next"); ?>"><?php echo _("Next"); ?></a>
	...
	<script>
		...
		function save() {
			...
			if (hexaValue == './assets/a.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – because the pencil and the penny are also hard."); ?></p>");
			...
			if (hexaValue == './assets/b.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – because only the penny is really strong."); ?></p>");
			...
			if (hexaValue == './assets/c.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – Both the glass and the penny are shiny."); ?></p>");
			...
			if (hexaValue == './assets/e.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Incorrect – The glass has no color."); ?></p>");
