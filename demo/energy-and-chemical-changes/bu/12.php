...
<head>
	...
	<style>
		h1 { color: #00dcca; margin-left: 3%; margin-right: 3%; font-size: 29px; }
		p { color: #000; }
...
<body>
	<div class="wrap">
		<div class="bg">
			<div>
				<h1><?php echo _("Reviewing key vocabulary related to... structures and properties of matter"); ?></h1>
				...
				<div class="container">
					<div class="main">
						<div class="column">
							...
							<button class="md-trigger md-setperspective" data-modal="modal-5"><?php echo _("Property of matter"); ?></button>
