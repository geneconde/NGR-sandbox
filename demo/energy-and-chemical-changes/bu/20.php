...
<head>
	...
	<style>
		...
		.wrap { border-color: #FDC30A; }
		.bg { background-image: url(assets/20/bg.jpg); background-size: 100% 100% !important; }

		#results { display: block; background-color: #448CCB; margin-top: 10%; color: #fff; padding: 9px 24px; text-align: center; border-radius: 5px; } 
		#results:hover { background: #296395; } 
...
<body>
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Structures and Properties of Matter review."); ?></p>
					</div>

					<div class="grid_12">
						<p><?php echo _("You can check how you did on the 'Quick Check' and 'Quiz Questions' for this review by clicking the button below."); ?></p>
					</div>
	...
	<div id="buttons">
		<a href="19.php" class="back" title="<?php echo _("Back"); ?>"><?php echo _("Back"); ?></a>
	</div>
