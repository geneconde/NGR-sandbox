...
<head>
	...
	<style>
		...
		#col1 { position: absolute; top: 40px; left: 40px; width: 280px !important; }
		#col2 { position: absolute; top: 40px; right: 140px; width: 240px !important; }
					...
					<div id="question">
						...
						<div class="container grid_12">
							<div id="container">
								...
								<ul id="col1">
									<li><div><?php echo _("Property of Matter"); ?></div></li>
								...
								<ul id="col2">
									<li><div><?php echo _("Part of Bike and Rider"); ?></div></li>
