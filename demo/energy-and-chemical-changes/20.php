...
<head>
	...
	<style>
		...
		p { text-align: center; margin: 2% 0; padding: 5px 10px; color: #fff; border-radius: 5px; }

		.wrap { border-color: #776000; }
...
<body>
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Energy and Chemical Changes module."); ?></p>
					</div>
	...
	<div id="buttons">
		<a href="19.php" class="back" title="<?php echo _("Back"); ?>"><i class="fa fa-arrow-left"></i></a>
	</div>
