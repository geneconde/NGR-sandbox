			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question" class="grid_12">
						<h1 class="grid_12"><?php echo _("Checking what you know... about human impact"); ?></h1>
						...
						<div class="grid_11 prefix_1">
							<form class="ac-custom ac-radio ac-swirl" autocomplete="off">
								<ol>
									<li><input id="a" type="radio"><label for="a"><span><?php echo _("If there's no other field in the area, they just move to a woods that's close-by."); ?></span></label></li>
									<li><input id="b" type="radio"><label for="b"><span><?php echo _("They change their eating and housing habits and live wherever they can."); ?></span></label></li>
									<li><input id="c" type="radio"><label for="c"><span><?php echo _("They live at the mall."); ?></span></label></li>
									<li><input id="d" type="radio"><label for="d"><span><?php echo _("If there isn't a similar habitat near the mall, the plant and animals may die."); ?></span></label></li>
								<ol>
							</form>
						</div>
