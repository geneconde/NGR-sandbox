...
<head>
	...
	<style>
		h1 { color: #ffa800; font-size: 28px; }
		h2 { text-align: center; margin-bottom: 0; color: #8560a8; }

		.wrap { border-color: #D3D318; }
		...
		#scenario img { width: auto; display: block; }
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="scenario">
						<h1 class="grid_12"><?php echo _("Using what you now know about... Newton's Third Law... to solve a problem"); ?></h1>

						<h2 class="grid_12"><?php echo _("The Scenario"); ?></h2>

						<p class="grid_12"><?php echo _("Your neighbor needs some help setting up a clothesline for drying clothes. Use your understanding of paired forces to help plan and design a system for setting up the clothesline for your neighbor."); ?></p>

						<!-- <img src="assets/12/12a.jpg" /> -->

						<!-- <div class="grid_8 prefix_2">
							<ul class="rslides slider">
								<li><img src="http://420placehold.it/tech/600-600-normal"></li>
								<li><img src="http://420placehold.it/tech/600-600-bw"></li>
								<li><img src="http://420placehold.it/tech/600-600-sepia"></li>
							</ul>
						</div> -->
					</div>
					...
					<div id="task">
						...
						<p class="grid_12"><?php echo _("What are some of the important considerations that must go into the design? How will you make certain that the clothesline will be able to support the clothes? Please answer in the space provided."); ?></p>
