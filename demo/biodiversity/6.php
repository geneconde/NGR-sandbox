...
#screen1 .placeholder { float: left; background: #a3def8; width: 255px; margin: 5px 20px 0 0; padding: 10px 10px 5px 10px; border-radius: 5px; }
#screen1 img { width: 255px; margin-bottom: 10px; }
