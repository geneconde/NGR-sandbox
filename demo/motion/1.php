...
<head>
	...
	<style>
		h1 { color: #ea6b48; padding-top: 75px; text-align: center; }
		
		.wrap { border-color: #858248; max-height: 100%; }
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Welcome to the Motion module") . ', ' . $user->getFirstName() . '!'; ?></h1>
