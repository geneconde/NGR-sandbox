...
<head>
	...
	<style>
		...
		#results { display: block; background: #000; margin-top: 10%; color: #fff; padding: 9px 24px; text-align: center; border-radius: 5px; } 
		#results:hover { background: #222; } 
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 ><?php echo _("Congratulations, ") . '' . $user->getFirstName(); ?>!</h1>

					<p class="grid_12"><?php echo _("You've completed the Motion module."); ?></p>
