...
<body>
	...
	<script>
		...
		function save() {
			...
			if (answer1 == 'B')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope! Wood is matter because it has mass and takes up space."); ?></p>");

			if (answer1 == 'C')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No! Steel is matter because it has mass and takes up space."); ?></p>");

			if (answer1 == 'D')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Thats wrong! Food is matter because it has mass and takes up space."); ?></p>");
			...
			if (answered == 0) {
				saveAnswer('structures-and-properties-of-matter-qc1-a', answerA.toLowerCase()); // Correct answer: light
