...
<head>
	...
	<style>
		...
		<?php if ($language == 'es_ES') : ?>
			p, h2, span { line-height: 28px;}
			.ac-custom li {padding: 5px 0;}
		<?php endif; ?>

		@media all and (max-width: 1245px){
			li { padding-top: 2px !important; }
			.diagram { height: 220px; margin-top: -15px; }
		}
...
<body>
	...
	<script>
		...
		function save() {
			...
			if (answer == 'A')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Wrong answer! A water droplet is made of millions of water molecules."); ?></p>");

			if (answer == 'B')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope! These molecules (individual particles) of water are very small and too small to see with the naked eye, or even with a microscope."); ?></p>");

			if (answer == 'C')
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No! Both the hydrogen and oxygen atoms are too small to see. Even the whole water molecule is too small to see with the naked eye, or even with a microscope."); ?></p>");
			...
			if (answered == 0) {
				saveAnswer('structures-and-properties-of-matter-qq1-a', answer); // Correct answer: A
				answered = 1;
			}
		}
