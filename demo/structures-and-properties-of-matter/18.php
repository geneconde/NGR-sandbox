...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question" class="grid_12">
						...
						<h2><?php echo _("If you were to take 1 ounce of sugar and add it to 4 ounces of Kool-Aid and stir it really well so you couldn’t see the sugar at all anymore, the final weight of the Kool-Aid would be..."); ?></h2>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Making a cold juice..."); ?></strong></section></section>
	...
	<script>
		...
		function save() {
			...
			if (hexaValue == './assets/a.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No! The final weight includes both the weight of the Kool-Aid (4 ounces) AND the weight of the sugar (1 ounce) = 5 ounces."); ?></p>");
			...
			if (hexaValue == './assets/b.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope! The final weight includes both the weight of the Kool-Aid (4 ounces) AND the full weight of the sugar (1 ounce) = 5 ounces."); ?></p>");
			...
			if (hexaValue == './assets/d.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Wrong answer! The final weight includes both the weight of the Kool-Aid (4 ounces) AND the full weight of the sugar (1 ounce) = 5 ounces."); ?></p>");
			...
			if (hexaValue == './assets/e.png') {
				...
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No! The final weight includes both the weight of the Kool-Aid (4 ounces) AND the full weight of the sugar (1 ounce) = 5 ounces."); ?></p>");
