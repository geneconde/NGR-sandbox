...
<head>
	...
	<style>
		...
		.bg { background-image: url(assets/15/bg.jpg); overflow: hidden !important; }
		...
		html[dir=rtl] #col1 { right: 40px; width: 100px; }
		html[dir=rtl] #col2 { right: 360px; width: 365px; }
		...
		<?php if ($language == 'es_ES') { ?>
			#col1, #col2 { top: 130px; }
			#answer .feedback { margin-top: 310px; }
		<?php } ?>

		<?php if ($language == 'ar_EG') { ?>
			#col1, #col2 { width: 200px !important; }
			#col2 li { padding: 5px 20px 5px 20px !important; }
			#col1-header { right: 60px !important; width: 130px !important; }
			#col2 { right: 425px !important; }
			#col2-header { right: 445px !important; }
			#col1 li img { margin-top: 0px !important; }
		<?php } ?>
	...
	<script>
		...
		function save() {
			...
			if (answer1 == 'cc' && answer2 == 'ce' && answer3 == 'cd' && answer4 == 'cb' && answer5 == 'ca') {
				$('#answer .feedback').html("<p class='green grid_10 prefix_1 suffix_1 '><img src='assets/correct.png'><?php echo _('Correct! The bike frame needs to be heard and strong to support the rider; the girl’s skin needs to be soft to touch, flexible to move and tough so it doesn’t get cut easily; the bike seat needs to be waterproof to keep it dry and soft to be comfortable; the shirt needs to be soft and warm to be comfortable and keep you warm; and the bike tire needs to be flexible and tough.'); ?></p>");
			} else {
				$('#answer .feedback').html("<p class='red grid_10 prefix_1 suffix_1 '><img src='assets/wrong.png'><?php echo _('Wrong! The bike frame needs to be heard and strong to support the rider; the girl’s skin needs to be soft to touch, flexible to move and tough so it doesn’t get cut easily; the bike seat needs to be waterproof to keep it dry and soft to be comfortable; the shirt needs to be soft and warm to be comfortable and keep you warm; and the bike tire needs to be flexible and tough.'); ?></p>");
			}
