...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="screen1" class="screen">
						<h1 class="grid_12"><?php echo _("Reviewing big ideas about... the structure and properties of matter"); ?></h1>
						<p class="grid_12"><?php echo _("All the \"stuff\" that you see or feel or use in your daily life is <span class='key'>matter</span>. The wood that makes up your house is matter. The food and water you eat and drink is matter. The metal that makes up your car is matter. But there's also a lot of matter you don't feel or see or smell or use. The air that you breathe is matter even if you can't see it! Matter is all the \"stuff\" that makes up the earth and the entire universe. The way scientists define matter is that matter is anything that has mass and takes up space."); ?></p>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Drinking water..."); ?></strong></section></section>
