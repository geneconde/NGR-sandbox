if( document.createElement('svg').getAttributeNS ) {
	...
	var checkbxsCross = Array.prototype.slice.call( document.querySelectorAll( 'form.ac-cross input[type="checkbox"]' ) ),
		radiobxsCross = Array.prototype.slice.call( document.querySelectorAll( 'form.ac-cross input[type="radio"]' ) ),
		...
		radiobxsList = Array.prototype.slice.call( document.querySelectorAll( 'form.ac-list input[type="radio"]' ) ),
		pathDefs = {
	...
	function controlRadiobox2( el, type, svgDef ) {
		var svg = createSVGEl( svgDef );
		el.parentNode.appendChild( svg );
		el.addEventListener( 'change', function() {
			resetRadio( el );
	...
	radiobxsCross.forEach( function( el, i ) { controlRadiobox( el, 'cross'); } );
	...
	radiobxsList.forEach( function( el ) { controlRadiobox2( el, 'list', { viewBox : '0 0 300 100', preserveAspectRatio : 'none' } ); } );
