...
<head>
	...
	<style>
		...
		@media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : portrait) and (-webkit-min-device-pixel-ratio: 1) {
			html[dir="rtl"] #question section img { margin: 0; }
		}
...
<body>
	<div class="wrap">
		<div class="bg">
			<div id="question">
				...
				<h2><?php echo _("What kind of energy does the bob have as it moves past the bottom (as shown in the drawing)?"); ?></h2>
				...
				<section>
					<ul>						
						...
						<li><input id="c" name="q" type="radio"><label for="c"><?php echo _("Potential"); ?></label></li>
						<li><input id="d" name="q" type="radio"><label for="d"><?php echo _("Heat"); ?></label></li>
					</ul>

					<img src="images/15/pendulum.png">
				</section>
			</div>

			<div id="answer">
				<h1><?php echo _("Quiz Question #2 - How did I do?"); ?></h1>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Swinging bobs"); ?></strong></section></section>
	...
	question.find('input[type=radio]').on('click', function() {
		...
		if (radio.attr('id') == 'a') {
			answer.find('.answer').html('<img src="images/15/pendulum.png"><p><?php echo _("Kinetic"); ?></p>');
			answer.find('.feedback').html('<p class="green"><img src="images/others/correct.png"> <?php echo _("Correct! Kinetic energy is the energy of a moving object."); ?></p>');
		}

		if (radio.attr('id') == 'b') {
			answer.find('.answer').html('<img src="images/15/pendulum.png"><p><?php echo _("Radiant"); ?></p>');
			answer.find('.feedback').html('<p class="red"><img src="images/others/wrong.png"> <?php echo _("No, kinetic energy is the energy of a moving object."); ?></p>');
		}

		if (radio.attr('id') == 'c') {
			answer.find('.answer').html('<img src="images/15/pendulum.png"><p><?php echo _("Potential"); ?></p>');
			answer.find('.feedback').html('<p class="red"><img src="images/others/wrong.png"> <?php echo _("No, objects that are not moving have potential energy."); ?></p>');
		}

		if (radio.attr('id') == 'd') {
			answer.find('.answer').html('<img src="images/15/pendulum.png"><p><?php echo _("Heat"); ?></p>');
			answer.find('.feedback').html('<p class="red"><img src="images/others/wrong.png"> <?php echo _("Not quite, the bob would heat the air around the bob, but the best choice is kinetic energy."); ?></p>');
		}
	});
	...
	function save() {
		...
		if (answered == 0) {
			saveAnswer('energy-and-its-forms-qq2-a', answer);
			answered = 1;
		}
	}
