...
<head>
	...
	<style>
		...
		#results { display: block; background-color: #C599C0; margin-top: 10%; color: #fff; padding: 9px 24px; text-align: center; border-radius: 5px; } 
		#results:hover { background: #93648D; } 
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the How Light Behaves module."); ?></p>
					</div>
