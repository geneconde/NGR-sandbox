...
<head>
	...
	<style>
		h1 { text-align: center; color: #F5FE6D; margin-top: 6%; }
		
		.wrap { border-color: #3C89F3; }
		.bg { background-image: url(assets/1/bg.jpg); background-size: 100% !important; }
		...
		#start span { margin: 86px 50px; display: block; }
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="screen1" class="screen">
						<h1 class="grid_12"><?php echo _("Welcome to the How Light Behaves module"); ?>, <?php echo $user->getFirstName() . "!" ?></h1>
