...
<head>
	...
	<style>
		...
		#col2 { position: absolute; top: 80px; right: 100px; width: 385px !important; }

		#col1 li { padding: 5px 30px 0px 20px; font-size: 20px; }
		#col2 li { padding: 5px 0 0 0; font-size: 20px; height: 50px;}

		#col1 img { height: 50px; }

		#container li div { background: #8ADCE5; padding: 15px 15px; -webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px; height: 20px;}
