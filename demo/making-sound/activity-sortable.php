...
<head>
	...
	<style>
		...
		#sortable li { background-color: #000; text-align: center; color: #fff; margin-bottom: 4px; border-radius: 5px; cursor: move; padding: 10px 5px; }
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question">
						...
						<h2 class="grid_12"><?php echo _("Based on the speed of sound in the materials listed in the table to the left, drag these items into order, with the material where sound would have the fastest speed on top, and the material where sound would have the slowest speed on the bottom."); ?></h2>
						...
						<div id="sortable-container" class="grid_4 prefix_1 suffix_1">
							<ul id="sortable">
								...
								<li id="3"><?php echo _("Air at 50 degrees F"); ?></li>
								<li id="4"><?php echo _("Seawater at 90 degrees F"); ?></li>
							</ul>
						</div>
						<div class="table grid_5 suffix_1">
							<h3><?php echo _("Data table 1: Speed of sound in different media"); ?></h3>
							<h3><?php echo _("Speed on sound in different mediums"); ?></h3>
							<table>
								<tr>
								...
								<tr>
									<td><?php echo _("Sea water at 77°F"); ?></td>
									<td>14,900</td>
								</tr>
								<tr>
