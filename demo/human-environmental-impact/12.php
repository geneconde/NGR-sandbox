...
<head>
	...
	<style>
		h1 { color: #00675F; font-size: 1.02em; }
		h2 { text-align: center; color: #004562; margin-bottom: 0; }
		p { color: #000; }

		.wrap { border-color: #FFE8AB; }
...
<body>
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="scenario">
						<h1 class="grid_12"><?php echo _("Using what you now know about... human environmental impact... to solve a problem"); ?></h1>
						<h2 class="grid_12"><?php echo _("The Scenario"); ?></h2>

						<p class="grid_12"><?php echo _("There is a really bad smell in your neighborhood from a river close by that is affecting you, your friends and your family. What could it be? How do you find out what it is? What is causing it?"); ?></p>
						
						<div class="grid_6 prefix_3">
						<img src="assets/12/river.jpg">
							<!-- <ul class="rslides">
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Changing bad habits..."); ?></strong></section></section>
