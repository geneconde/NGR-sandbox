...
<head>
	...
	<style>
		h1 { color: #8e569b; font-size: 1.27em; }
		...
		<?php if ($language == 'es_ES') : ?>
			h1 { font-size: 1.1em; }
			@media screen and (max-width: 1250px){ p { font-size: 20px;} }
		<?php endif; ?>
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Checking what you now know about... human environmental impact"); ?></h1>
