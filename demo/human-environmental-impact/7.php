...
<head>
	...
	<style>
		...
		<?php if ($language == 'es_ES') : ?>
			h2, .ac-custom label, #answers p  { line-height: 25px; }
				
			@media screen and (max-width: 1250px){
				h2, .ac-custom label, #answers p { font-size: 20px; line-height: 20px;  }
			}
			@media screen and (max-width: 960px){ .ac-custom li {padding: .28em 0; } }
...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="questions">
						...
						<div id="question2">
							<h2 class="grid_12"><?php echo _("Question B. The <span class='blink'>most</span> important purpose for bodies of water to fulfill the most basic human needs is for:"); ?></h2>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Clicking to answer..."); ?></strong></section></section>
	...
	<script>
		...
		function save() {
			...
			if (answer1 == 'B')
				$('#answer1 .feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("No - The environment is not there just to make humans comfortable. It's there to support the survival of all living things equally."); ?></p>");
