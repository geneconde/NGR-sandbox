...
function init() {
	...
	var manifest = [
		{src:"images/2/FGflatImage.png", id:"FGflatImage"},
		{src:"images/2/FGflatImage_1.png", id:"FGflatImage_1"},
...
<style>
h1 { color: #769789; }
.wrap { position: relative; border-color: #A6E3FF; }
.bg { position: relative; z-index: 3; }
.bg p { font-size: 22px; }
#canvas { margin: 0 auto; position: absolute; z-index: 2; background: #50aa53; }
...
<body onload="init();">
	<div class="wrap">
		...
		<div class="bg">
			<div>
				<h1><?php echo _("Thinking about... natural resources"); ?></h1>
				<p><?php echo _("Have you ever thought about everything that it takes to meet your needs and make your life comfortable? And where it all comes from? What does it take to make the heat and air conditioning work? Energy! Where does that energy come from? How about when you get thirsty or hungry? Water and food - where do they come from? Nature – that's where. All of the things we take for granted to help us survive and make our lives enjoyable are either materials or energy found in nature. We call these materials and energy natural resources. Just think about what your everyday life would be like if natural resources didn't exist."); ?></p>
			</div>				
		</div>
	</div>
