...
<head>
	...
	<style>
		...
		p { text-align: center; margin: 2% 0; color: #593622;/*  padding: 5px 10px; background: rgba(255, 255, 255, .6); color: #000; border-radius: 5px; */ }

		.wrap { border-color: #b6b587; }
		.bg { background-image: url(assets/22/CongratulationsPage.jpg); background-size: 100% 100% !important; }

		#results { display: block; background-color: #E5B467; margin-top: 10%; color: black; padding: 9px 24px; text-align: center; border-radius: 5px; border: 2px solid black; } 
		#results:hover { background: #FFCC62; } 
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div class="grid_12">
						<p><?php echo _("You've completed the Forces of All Kinds module."); ?></p>
					</div>
