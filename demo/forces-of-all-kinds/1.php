...
<head>
	...
	<style>
		h1 { text-align: center; color: #440a7f; margin-top: 3%; font-size: 1.4em;}
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="screen1" class="screen">
						<h1 class="grid_12"><?php echo _("Welcome to the Forces of All Kinds module"); ?>, <?php echo $user->getFirstName() . "!" ?></h1>
