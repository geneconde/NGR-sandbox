...
<head>
	...
	<style>
		h1 { color: #ff8b14; font-size: 30px;}
		h2 { text-align: center; color: #830d3c; margin-bottom: 0; }

		.wrap { border-color: #457E8C; }
		.bg { background-image: url(assets/12/bg.jpg); }

		

		.slider img { height: 340px; border: 2px solid #687796; }
...
<body>
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="scenario">
						<h1 class="grid_12"><?php echo _("Using what you now know about... electric circuits... to solve a problem"); ?></h1>
						<h2 class="grid_12"><?php echo _("The Scenario"); ?></h2>

						<p class="grid_12"><?php echo _("Think about what would happen if you were out camping and it was going to get dark in about an hour and you tried out your flashlight and it didn’t work."); ?></p>
					...
					<div id="task">
						...
						<p class="grid_12"><?php echo _("Use what you know about simple circuits to “trouble shoot” the broken flashlight to try and figure out what’s wrong with it. Talk about all the things you would check and what you might be able to do to fix it."); ?></p>
	...
	<section id="preloader"><section class="selected"><strong><?php echo _("Using a flashlight..."); ?></strong></section></section>
