...
@media only screen and (max-device-width : 768px)  and (-webkit-min-device-pixel-ratio: 1) {
    ...
    @media screen and (max-width: 1250px) { .bg { background-size: 100% calc(100% - 34px)!important; background-position: 0 34px; } }
    @media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : landscape) {
    	#start { top: 544px; } 
    	h1, #screen2, #screen3, #screen4 { padding-top: 81px !important; }	
    }
    @media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : portrait) {
    	h1, #screen2, #screen3, #screen4 { padding-top: 100px !important; }	 
    }
</style>
</head>
<body>
