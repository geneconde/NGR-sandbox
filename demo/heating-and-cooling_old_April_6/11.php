...
<head>
	...
	<style>
		...
		#question1, #question2, #answer1, #answer2 { overflow: hidden; background-color: rgba(135, 206, 250, .3); margin: 0 auto; -webkit-border-radius:10px; -moz-border-radius:10px; border-radius:10px;	margin-bottom: 10px; padding: 0 10px; width: 100%; }
    ...
    th, td { width: 125px; background: rgba(255, 255, 255, 0.7); border-radius: 5px; }
   #question1 table img { height: 70px; margin: 0 20px; border-radius: 10px; }
	...
	@media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : landscape) {
		#question1 table img { height: 60px; }
	}
	</style>
...
<body>
				...
				<div id="question1">
					<h2><?php echo _("Question A. Drag each item into the column that best describes how it acts—as a conductor of heat or as an insulator."); ?></h2>
   					<table>
						...
						<tr>
							<td class="q1f"><img id="drag6" class="drag" src="images/11/fish.jpg" alt="<?php echo _("Frozen fish wrapped in aluminum foil"); ?>"></td>
							<td id="q1f1"></td>
							<td id="q1f2"></td>
						</tr>
				...
				<div id="question2">
					...
					<ul>
						<li>
							...
							<label for="a2"><span></span><?php echo _("1 - Conductor, 2 - Insulator"); ?></label>
						</li>
						<li>
							<input type="radio" name="q2" id="b2" value="B">
							<label for="b2"><span></span><?php echo _("1 - Conductor, 2 - Conductor"); ?></label>
						</li>
						<li>
							<input type="radio" name="q2" id="c2" value="C">
							<label for="c2"><span></span><?php echo _("1 - Insulator, 2 - Conductor"); ?></label>
						</li>
						<li>
							<input type="radio" name="q2" id="d2" value="D">
							<label for="d2"><span></span><?php echo _("1 - Insulator, 2 - Insulator"); ?></label>
						</li>
					</ul>
				</div>
			</div>
	...
	q2.on('click', function() {
      ...
      if (radio == 'A') {
				answer2.find('.answer').html('<p><?php echo _("1 - Conductor, 2 - Insulator"); ?></p>');
        ...
        ans2 = 'A';
			...
			if (radio == 'B') {
				answer2.find('.answer').html('<p><?php echo _("1 - Conductor, 2 - Conductor"); ?></p>');
        ...
        ans2 = 'B';
			...
			if (radio == 'C') {
				answer2.find('.answer').html('<p><?php echo _("1 - Insulator, 2 - Conductor"); ?></p>');
        ...
        ans2 = 'C';
			...
			if (radio == 'D') {
				answer2.find('.answer').html('<p><?php echo _("1 - Insulator, 2 - Insulator"); ?></p>');
