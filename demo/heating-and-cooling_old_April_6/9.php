...
<head>
	...
	<style>
		...
		.bg { background-image: url('images/9/bg.jpg'); background-repeat: no-repeat; background-size: 100% 100%; width:100%; height:100%; position: relative; }
		.bg li { padding: 0; }
		...
		@media only screen and (min-device-width : 768px) and (max-device-width : 1024px) and (orientation : landscape) {
			#question2 h2, #answers h2 { font-size: 21px; }
		}
	...
	<div class="wrap">
		<div class="bg">
			<div id="questions">
				...
				<div id="question1">
					<h2><?php echo _("Question A. Drag the heat transfer method on example it matches."); ?></h2>
