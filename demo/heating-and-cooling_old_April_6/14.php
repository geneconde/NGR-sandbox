				...
				<div class="md-modal md-effect" id="modal-5">
					<div class="md-content">
						...
						<div>
							...
							<p class="smaller"><?php echo _("Another example is sawdust. If someone takes an axe and chops into wood, some of the wood breaks into tiny pieces and becomes sawdust. The sawdust is still wood. It is just wood in a different form. It has gone through a physical change."); ?></p>
							<button class="md-close"><?php echo _("Close me!"); ?></button>
						</div>
					</div>
				</div>
				...
				<div class="md-modal md-effect" id="modal-8">
					<div class="md-content">
						...
						<div>
							...
							<p><?php echo _("Convection is when something moves by changing places. Heat can move from one place to another by convection. It is always warmer near the ceiling of a room than on the floor because the warmer air rises to the ceiling by convection. Warm water also rises by convection."); ?></p>
							<button class="md-close"><?php echo _("Close me!"); ?></button>
						</div>
					</div>
				</div>
