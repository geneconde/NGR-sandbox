...
<head>
	...
	<style>
		...
		h1 { color: #D60BC6; padding-top: 75px; text-align: center; }
		
		.wrap { border-color: #E293E2; max-height: 100%; }
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Welcome to the Electric Charge module") . ', ' . $user->getFirstName() . '!'; ?></h1>
