...
<body>
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="question" class="grid_12">
						...
						<h2><?php echo _("A ping pong ball is tied to a string and then gains some electrons through charging by contact. It is then dangled in between two metal spheres: one with a positive charge and the other with a negative charge. Choose the arrow that represents the direction that the forces due to the charged spheres will cause ping pong ball to move."); ?></h2>
						...
						<div class="grid_3 fix">
							...
							<label for="a"><img src="assets/16/a.jpg"></label>
						</div>

						<div class="grid_3 fix">
							<input type="radio" id="b" name="q" value="B">
							<label for="b"><img src="assets/16/b.jpg"></label>
						</div>

						<div class="grid_3 fix">
							<input type="radio" id="c" name="q" value="C">
							<label for="c"><img src="assets/16/c.jpg"><span></label>
						</div>

						<div class="grid_3 fix">
							<input type="radio" id="d" name="q" value="D">
							<label for="d"><img src="assets/16/d.jpg"><span></label>
						</div>
	...
	<script>
		...
		function save() {
			...
			if (answer == 'A'){
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope.  The ping pong ball has extra electrons, meaning that it carries a negative charge.  It would be repelled by the negatively charged sphere, and attracted to the positively charged sphere."); ?></p>");
			} 
			else if (answer == 'B') {
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope.  The ping pong ball has extra electrons, meaning that it carries a negative charge.  It would be repelled by the negatively charged sphere, and attracted to the positively charged sphere."); ?></p>");
			}
			else if (answer == 'C') {
				$('.feedback').html("<p class='green'><img src='assets/correct.png'><?php echo _("You’ve got it!  The ping pong ball with extra electrons would be repelled or pushed away by the negatively charge sphere, and would be attracted to the positively charge sphere.  This would cause the ping pong ball to move to the left."); ?></p>");
			}
			else if (answer == 'D') {
				$('.feedback').html("<p class='red'><img src='assets/wrong.png'><?php echo _("Nope.  The ping pong ball has extra electrons, meaning that it carries a negative charge.  It would be repelled by the negatively charged sphere, and attracted to the positively charged sphere."); ?></p>");
			}
