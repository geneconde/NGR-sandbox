...
<head>
	...
	<style>
		...
		.wrap { border-color: #F5A124; }
		.bg { background-image: url(assets/22/bg.jpg); }

		#results { display: block; background: #B929B9; margin-top: 10%; color: #fff; padding: 9px 24px; text-align: center; border-radius: 5px; } 
		#results:hover { background: #872DB9; } 
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<p class="grid_12"><?php echo _("You've completed the Electric Charge module."); ?></p>
