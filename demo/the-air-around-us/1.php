...
<head>
	...
	<style>
		...
		.wrap { border-color: #2CDDFB; }
		.bg { background-image: url(assets/1/bg.jpg); background-size: 100% 100% !important; }
			...
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<div id="screen1" class="screen">
						<h1 class="grid_12"><?php echo _("Welcome to the Air Around Us module"); ?>, <?php echo $user->getFirstName() . "!" ?></h1>
