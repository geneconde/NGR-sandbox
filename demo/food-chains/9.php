...
$(document).ready(function() {
	...
	*/
	...
	$('img.check-toggle').click(function(){
		...
		var answer = null;
		if (hexavalue == './images/9/3.png') answer = 3;
		if (hexavalue == './images/9/4.png') answer = 4;
		if (hexavalue == './images/9/5.png') answer = 5;
		if (hexavalue == './images/9/6.png') answer = 6;
		...
		//get/set answer here correct = 0;
		if (answered == 0) {
			saveAnswer('food-chains-qc3-a', answer);
			answered = 1;
		}
	});
});
...
.bg { background-color:#FFE5DF;   background-repeat: no-repeat; background-size: 100% 100%; width:100%; height:100%; position:relative; }
...
#foodweb,#box { float:left; width: 44%;text-align: center; margin: 3%; }
#foodweb img { max-width:100%; height: auto;}
...
<body>
	<div class="wrap" >
		<div class="bg"  >
			<h1><?php echo _("Quick Check #3"); ?> <span class="hidden">- <?php echo _("How did I do?"); ?></span></h1>
			<div id="question">
				<h2><?php echo _("In the food web shown at the left, how many things <span class='orange bold'>directly or indirectly</span> provide energy for the <span class='brown purple'>snake</span>?"); ?></h2>
				<div id="foodweb">
					<img src="images/9/foodweb.png">
				</div>
				<div id="box">
					<h2><?php echo _("Rotate or flip the 3D box below either up or down to set your answer."); ?></h2>
					<h3 class="red"><?php echo _("Click, hold and slide mouse up or down."); ?></h3>
					<div id="hexaflip"></div>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div id="answer" class="hidden">
				<div id="foodweb">
					<img src="images/9/foodweb-answer.png">
				</div>
				<div id="box">
					<h2><?php echo _("If you answered..."); ?></h2>
					<br/><img src="images/9/6.png"><br/><br/>
					<h2><?php echo _("Then you are right! Even though the snake does not eat grass, corn or grasshoppers, the snake eats things that eat them so the snake gets energy indirectly from these things too!"); ?></h2>
				</div>
			</div>
			<div class="clear"></div>
		</div>
