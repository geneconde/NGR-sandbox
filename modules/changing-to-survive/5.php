<?php
	...
	if($user->getType() == 2) {
		...
		$sa = $uf->getStudentAnswer($_SESSION['smid'], 'changing-to-survive-qc1-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
...
<body>
	...
	$(document).ready(function() {
		...
		$('img.back-toggle').click(function(){
			if($('#answer').is(':visible')) {
				...
				$('img.back-toggle').parent().attr('href','4.php#screen3');
			}
	...
	function save() {
		if (answered == 0) {
			saveAnswer('changing-to-survive-qc1-a', answer1);
			saveAnswer('changing-to-survive-qc1-b', answer2);
		}
	}
	</script>
