<?php
	...
	if($user->getType() == 2) {
		...
		$sa = $uf->getStudentAnswer($_SESSION['smid'], 'changing-to-survive-qc3-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
...
<body>
	...
	function save() {
		if (answered == 0) {
			saveAnswer('changing-to-survive-qc3-a', answer1);
			saveAnswer('changing-to-survive-qc3-b', answer2);
		}
	}
	</script>
