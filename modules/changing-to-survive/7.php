<?php
	...
	if($user->getType() == 2) {
		...
		$sa = $uf->getStudentAnswer($_SESSION['smid'], 'changing-to-survive-qc2-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
...
<body>
	...
	var feedback1 = "";
	var feedback2 = "";
	var answericon1 = $('#answer-icon1'), answericon2 = $('#answer-icon2') ,answer1, answer2, textstr1, textstr2, studentAnswer1, studentAnswer2, nullAnswer;
	...
	function save() {
		if (answered == 0) {
			saveAnswer('changing-to-survive-qc2-a', answer1);
			saveAnswer('changing-to-survive-qc2-b', answer2);
		}
	}
