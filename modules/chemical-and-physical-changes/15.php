...
<head>
	...
	<style>
		h1 { color: #93648D; font-size: 30px; }
		p { text-align: center; color: #000; }

		.wrap { border-color: #FFD9FF; }
		.bg { background-image: url(assets/15/bg.jpg); overflow: hidden; background-size: 100% 100% !important;}
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Checking what you now know about… chemical and physical changes"); ?></h1>
