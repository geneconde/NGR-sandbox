<?php 
	...
	if($user->getType() == 2) {
		...
		$sa = $uf->getStudentAnswer($_SESSION['smid'], 'doing-science-qc1-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
<!DOCTYPE html>
...
label { margin:5px 0px !important; font-size:22px; cursor: pointer; }
		...
		<div class="bg">			
			...
			<div id="answer" class="screens">
				<section>
					...
					<div id="q-container1">
						<h2><?php echo _("Question A. Mark <span class='bold red blink'>ALL</span> the ways that a hypothesis helps in conducting a scientific investigation.");?>.</h2>
						<p><img src="images/others/wrong.png" id="answer-icon" class="resize"/><span id='user_answer'></span></p><br/>
					</div>
					<div id="q-container2">
						<h2><?php echo _("Question B. After experimenting many times, a scientist does not get any data to support the hypothesis. What should this person do now?");?></h2>
