<?php
	...
	if($user->getType() == 2) $uf->updateStudentLastscreen(17, $_SESSION['smid']);
?>
...
<head>
	...
	<style>
		...
		.bg { background-image: url(assets/17/bg.jpg);overflow: hidden; }
		...
		<div class="bg">
			<div class="container_12 clearfix">
				<div class="grid_12">
					...
					<h1 class="grid_12"><?php echo _("Checking what you now know about... basic cells"); ?></h1>
