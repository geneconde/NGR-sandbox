<?php
	...
	if($user->getType() == 2) {
		...
		$sa = $uf->getStudentAnswer($_SESSION['smid'], 'earth-materials-and-systems-qc4-a');
		$answered = ($sa ? 1 : 0 );
	} else $answered = 1;
?>
...
<body>
	...
	<script>
	var ans1, ans2, ans3, answered = <?php echo $answered; ?>, checkAnswer = 0, checkAnswer2 = 0;
	...
	function save() {
		if (answered == 0) {
			...
			saveAnswer('earth-materials-and-systems-qc4-c', ans3);
		}
	}
