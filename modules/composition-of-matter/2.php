...
<body onload="init();">
	<div class="wrap">
		...
		<div class="bg">
			<div>
				<h1><?php echo _('Thinking about... the composition of matter'); ?></h1>
				<p><?php echo _('The physical world all around us is made up of many things. We know that objects have similarities and differences, but have you ever thought about what makes them similar or different? Scientists and engineers spend a lot of time studying the similarities and differences in the properties of materials and use that knowledge to identify and make things and to even make new materials.'); ?></p>
			</div>
		</div>
	</div>
